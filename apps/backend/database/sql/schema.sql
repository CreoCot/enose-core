-- ===========================================================================
-- REFERENCE DOCUMENT — DO NOT EXECUTE AT RUNTIME.
--
-- The authoritative database schema lives in the versioned migrations under
-- database/migrations/ (000001_init.up.sql and future versions). This file is
-- kept only as a human-readable validation reference and is NOT embedded or
-- executed by the backend. Treat the migrations as the source of truth.
-- ===========================================================================
