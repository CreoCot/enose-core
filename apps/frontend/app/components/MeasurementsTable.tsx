...
const MeasurementsTable = ({
  ...
  }, [table, sensorSize, absoluteData, renderedPlotIds, initialData]);
  ...
  return (
    <div className="flex bg-grey-100 rounded-[10px] shadow-md shadow-primary-300 border border-primary-300 md:mx-8 my-4 lg:py-5 px-4 md:px-5 2xl:px-6">
      <SensorList
