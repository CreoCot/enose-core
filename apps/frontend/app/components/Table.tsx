...
const Table = ({ table, sensorSize, error }: Props) => {
  ...
  return (
    <>
      ...
      {sensorSize !== 0 && (
        <div className="mx-8 my-4 inline-block overflow-hidden rounded-[10px] shadow-md shadow-primary-300 border border-primary-300 overflow-x-auto overscroll-none">
